...
$packages["github.com/gopherjs/gopherjs/js"] = (function() {
	var $pkg = {}, $init, Object, Error, S, sliceType, ptrType, ptrType$1, init;
...
$packages["github.com/neelance/go-angularjs"] = (function() {
	var $pkg = {}, $init, js, Module, Scope, HttpService, ptrType, funcType, funcType$1, sliceType, funcType$2, ptrType$1, funcType$3, ptrType$2, funcType$5, ptrType$5, NewModule, Service;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	Module = $pkg.Module = $newType(0, $kindStruct, "angularjs.Module", "Module", "github.com/neelance/go-angularjs", function(Object_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			return;
	...
	Scope = $pkg.Scope = $newType(0, $kindStruct, "angularjs.Scope", "Scope", "github.com/neelance/go-angularjs", function(Object_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			return;
	...
	HttpService = $pkg.HttpService = $newType(0, $kindStruct, "angularjs.HttpService", "HttpService", "github.com/neelance/go-angularjs", function() {
		this.$val = this;
		if (arguments.length === 0) {
			return;
		}
	...
	funcType$2 = $funcType([$String, $Int, ptrType, ptrType], [], false);
	ptrType$1 = $ptrType(Scope);
	funcType$3 = $funcType([ptrType$1], [], false);
	ptrType$2 = $ptrType(Module);
	funcType$5 = $funcType([$String, $Int], [], false);
	ptrType$5 = $ptrType(HttpService);
	Module.ptr.prototype.NewController = function(name, constructor) {
		var $ptr, constructor, m, name;
		m = this;
		m.Object.controller($externalize(name, $String), $externalize(new js.S([new $String("$scope"), new funcType((function $b(scope) {
			var $ptr, scope, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; scope = $f.scope; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			$r = constructor(new Scope.ptr(scope)); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f.scope = scope; $f.$s = $s; $f.$r = $r; return $f;
		}))]), js.S));
	};
	...
	Scope.ptr.prototype.Apply = function(f) {
		var $ptr, f, s;
		s = this;
		s.Object.$apply($externalize(f, funcType$1));
	};
	Scope.prototype.Apply = function(f) { return this.$val.Apply(f); };
	Scope.ptr.prototype.EvalAsync = function(f) {
		var $ptr, f, s;
		s = this;
		s.Object.$evalAsync($externalize(f, funcType$1));
	};
	Scope.prototype.EvalAsync = function(f) { return this.$val.EvalAsync(f); };
	NewModule = function(name, requires, configFn) {
		var $ptr, configFn, name, requires;
		return new Module.ptr($global.angular.module($externalize(name, $String), $externalize(requires, sliceType), $externalize(configFn, funcType$1)));
	};
	$pkg.NewModule = NewModule;
	Service = function(name) {
		var $ptr, name;
		return $global.angular.element($global.document).injector().get($externalize(name, $String));
	};
	$pkg.Service = Service;
	HttpService.ptr.prototype.Get = function(url, callback) {
		var $ptr, callback, future, s, url;
		s = this;
		future = Service("$http").get($externalize(url, $String));
		future.success($externalize((function $b(data, status, headers, config) {
			var $ptr, config, data, headers, status, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; config = $f.config; data = $f.data; headers = $f.headers; status = $f.status; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			$r = callback(data, status); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f.config = config; $f.data = data; $f.headers = headers; $f.status = status; $f.$s = $s; $f.$r = $r; return $f;
		}), funcType$2));
		future.error($externalize((function $b(data, status, headers, config) {
			var $ptr, config, data, headers, status, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; config = $f.config; data = $f.data; headers = $f.headers; status = $f.status; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			$r = callback(data, status); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f.config = config; $f.data = data; $f.headers = headers; $f.status = status; $f.$s = $s; $f.$r = $r; return $f;
	...
	HttpService.prototype.Get = function(url, callback) { return this.$val.Get(url, callback); };
	ptrType$2.methods = [{prop: "NewController", name: "NewController", pkg: "", typ: $funcType([$String, funcType$3], [], false)}];
	ptrType$1.methods = [{prop: "Apply", name: "Apply", pkg: "", typ: $funcType([funcType$1], [], false)}, {prop: "EvalAsync", name: "EvalAsync", pkg: "", typ: $funcType([funcType$1], [], false)}];
	ptrType$5.methods = [{prop: "Get", name: "Get", pkg: "", typ: $funcType([$String, funcType$5], [], false)}];
	Module.init([{prop: "Object", name: "", pkg: "", typ: ptrType, tag: ""}]);
	Scope.init([{prop: "Object", name: "", pkg: "", typ: ptrType, tag: ""}]);
	HttpService.init([]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		$pkg.HTTP = new HttpService.ptr();
		/* */ } return; } if ($f === undefined) { $f = { $blk: $init }; } $f.$s = $s; $f.$r = $r; return $f;
	};
	$pkg.$init = $init;
	return $pkg;
...
$packages["sync"] = (function() {
	var $pkg = {}, $init, runtime, atomic, Pool, Mutex, poolLocal, syncSema, ptrType, sliceType, chanType, sliceType$1, ptrType$2, ptrType$4, ptrType$6, sliceType$3, funcType, ptrType$10, arrayType, semWaiters, allPools, runtime_Syncsemcheck, runtime_registerPoolCleanup, runtime_Semacquire, runtime_Semrelease, poolCleanup, init, indexLocal, init$1;
...
$packages["strings"] = (function() {
	var $pkg = {}, $init, errors, js, io, unicode, utf8, HasPrefix, TrimPrefix;
	errors = $packages["errors"];
	js = $packages["github.com/gopherjs/gopherjs/js"];
	io = $packages["io"];
...
$packages["github.com/AmandaCameron/go-search"] = (function() {
	var $pkg = {}, $init, angularjs, strings, command, Commands, Searcher, Results, Result, angularResults, sliceType, sliceType$1, funcType, ptrType, funcType$1, ptrType$1, Run;
	angularjs = $packages["github.com/neelance/go-angularjs"];
	strings = $packages["strings"];
	command = $pkg.command = $newType(0, $kindStruct, "search.command", "command", "github.com/AmandaCameron/go-search", function(Result_, searcher_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Result = new Result.ptr();
			this.searcher = $throwNilPointerError;
			return;
		}
		this.Result = Result_;
		this.searcher = searcher_;
	});
	Commands = $pkg.Commands = $newType(4, $kindMap, "search.Commands", "Commands", "github.com/AmandaCameron/go-search", null);
	Searcher = $pkg.Searcher = $newType(4, $kindFunc, "search.Searcher", "Searcher", "github.com/AmandaCameron/go-search", null);
	Results = $pkg.Results = $newType(8, $kindInterface, "search.Results", "Results", "github.com/AmandaCameron/go-search", null);
	Result = $pkg.Result = $newType(0, $kindStruct, "search.Result", "Result", "github.com/AmandaCameron/go-search", function(Valid_, Title_, Subtitle_, Icon_, URL_, ID_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Valid = false;
			this.Title = "";
	...
	angularResults = $pkg.angularResults = $newType(0, $kindStruct, "search.angularResults", "angularResults", "github.com/AmandaCameron/go-search", function(Scope_, results_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Scope = ptrType.nil;
			this.results = sliceType$1.nil;
			return;
		}
		this.Scope = Scope_;
	...
	sliceType = $sliceType($String);
	sliceType$1 = $sliceType(Result);
	funcType = $funcType([$Int], [], false);
	ptrType = $ptrType(angularjs.Scope);
	funcType$1 = $funcType([$String, $String], [], false);
	ptrType$1 = $ptrType(angularResults);
	Commands.prototype.Add = function(name, title, subtitle, searcher) {
		var $ptr, _key, commands, name, searcher, subtitle, title;
		commands = this.$val;
		if (subtitle === "") {
			subtitle = "Command";
		}
		_key = name; (commands || $throwRuntimeError("assignment to entry in nil map"))[_key] = { k: _key, v: new command.ptr(new Result.ptr(false, title, subtitle, "", name, ""), searcher) };
	};
	$ptrType(Commands).prototype.Add = function(name, title, subtitle, searcher) { return new Commands(this.$get()).Add(name, title, subtitle, searcher); };
	Commands.prototype.Process = function(inp, results) {
		var $ptr, _entry, _i, _keys, _ref, cmd, commands, inp, res, results, $s, $r;
		/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; _entry = $f._entry; _i = $f._i; _keys = $f._keys; _ref = $f._ref; cmd = $f.cmd; commands = $f.commands; inp = $f.inp; res = $f.res; results = $f.results; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		commands = this.$val;
		if (commands === false) {
			return false;
		}
		...
		/* while (true) { */ case 1:
			...
			cmd = _entry.k;
			res = $clone(_entry.v, command);
			/* */ if (strings.HasPrefix(cmd, inp)) { $s = 3; continue; }
			/* */ $s = 4; continue;
			/* if (strings.HasPrefix(cmd, inp)) { */ case 3:
				$r = results.AddResult(res.Result); /* */ $s = 5; case 5: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			/* } */ case 4:
			/* */ if (strings.HasPrefix(inp, cmd + " ")) { $s = 6; continue; }
			/* */ $s = 7; continue;
			/* if (strings.HasPrefix(inp, cmd + " ")) { */ case 6:
				$r = res.searcher(strings.TrimPrefix(inp, cmd + " "), results); /* */ $s = 8; case 8: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
				return true;
			/* } */ case 7:
			_i++;
		/* } */ $s = 1; continue; case 2:
		return false;
		/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: Commands.prototype.Process }; } $f.$ptr = $ptr; $f._entry = _entry; $f._i = _i; $f._keys = _keys; $f._ref = _ref; $f.cmd = cmd; $f.commands = commands; $f.inp = inp; $f.res = res; $f.results = results; $f.$s = $s; $f.$r = $r; return $f;
	};
	$ptrType(Commands).prototype.Process = function(inp, results) { return new Commands(this.$get()).Process(inp, results); };
	Run = function(searcher) {
		var $ptr, module, searcher;
		module = angularjs.NewModule("search-app", sliceType.nil, (function() {
			var $ptr;
		}));
		module.NewController("Search", (function(scope) {
			var $ptr, scope;
			scope.Object.results = $externalize(new sliceType$1([]), sliceType$1);
			scope.Object.input = $externalize("", $String);
			scope.Object.selected = 0;
			scope.Object.keyDown = $externalize((function(keyCode) {
				var $ptr, keyCode;
				console.log("got keyDown:", keyCode);
				if (keyCode === 38) {
					scope.Object.selected = ($parseInt(scope.Object.selected) >> 0) - 1 >> 0;
				} else if (keyCode === 40) {
					scope.Object.selected = ($parseInt(scope.Object.selected) >> 0) + 1 >> 0;
				}
				if (($parseInt(scope.Object.selected) >> 0) < 0) {
					scope.Object.selected = scope.Object.results.length;
				} else if (($parseInt(scope.Object.selected) >> 0) > ($parseInt(scope.Object.results.length) >> 0)) {
					scope.Object.selected = 0;
				}
			}), funcType);
			scope.Object.$watch($externalize("input", $String), $externalize((function(inp, oldValue) {
				var $ptr, inp, oldValue;
				$go((function $b() {
					var $ptr, r, $s, $r;
					...
					r = new angularResults.ptr(scope, sliceType$1.nil);
					$r = searcher(inp, r); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
					scope.Apply($methodVal(r, "print"));
					/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f.r = r; $f.$s = $s; $f.$r = $r; return $f;
				}), []);
			}), funcType$1));
		}));
	};
	$pkg.Run = Run;
	angularResults.ptr.prototype.Len = function() {
		var $ptr, results;
		results = this;
		return results.results.$length;
	};
	angularResults.prototype.Len = function() { return this.$val.Len(); };
	angularResults.ptr.prototype.AddResult = function(r) {
		var $ptr, r, results;
		results = this;
		r = $clone(r, Result);
		results.results = $append(results.results, r);
	};
	angularResults.prototype.AddResult = function(r) { return this.$val.AddResult(r); };
	angularResults.ptr.prototype.Error = function(err) {
		var $ptr, _r, err, results, $s, $r;
		/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; _r = $f._r; err = $f.err; results = $f.results; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		results = this;
		results.results = sliceType$1.nil;
		_r = err.Error(); /* */ $s = 1; case 1: if($c) { $c = false; _r = _r.$blk(); } if (_r && _r.$blk !== undefined) { break s; }
		$r = results.AddResult(new Result.ptr(false, "Error Searching", _r, "", "", "")); /* */ $s = 2; case 2: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: angularResults.ptr.prototype.Error }; } $f.$ptr = $ptr; $f._r = _r; $f.err = err; $f.results = results; $f.$s = $s; $f.$r = $r; return $f;
	};
	angularResults.prototype.Error = function(err) { return this.$val.Error(err); };
	angularResults.ptr.prototype.print = function() {
		var $ptr, results;
		results = this;
		results.Scope.Object.selected = 0;
		results.Scope.Object.results = $externalize(results.results, sliceType$1);
	};
	angularResults.prototype.print = function() { return this.$val.print(); };
	Commands.methods = [{prop: "Add", name: "Add", pkg: "", typ: $funcType([$String, $String, $String, Searcher], [], false)}, {prop: "Process", name: "Process", pkg: "", typ: $funcType([$String, Results], [$Bool], false)}];
	ptrType$1.methods = [{prop: "Len", name: "Len", pkg: "", typ: $funcType([], [$Int], false)}, {prop: "AddResult", name: "AddResult", pkg: "", typ: $funcType([Result], [], false)}, {prop: "Error", name: "Error", pkg: "", typ: $funcType([$error], [], false)}, {prop: "print", name: "print", pkg: "github.com/AmandaCameron/go-search", typ: $funcType([], [], false)}];
	command.init([{prop: "Result", name: "", pkg: "", typ: Result, tag: ""}, {prop: "searcher", name: "searcher", pkg: "github.com/AmandaCameron/go-search", typ: Searcher, tag: ""}]);
	Commands.init($String, command);
	Searcher.init([$String, Results], [], false);
	Results.init([{prop: "AddResult", name: "AddResult", pkg: "", typ: $funcType([Result], [], false)}, {prop: "Error", name: "Error", pkg: "", typ: $funcType([$error], [], false)}, {prop: "Len", name: "Len", pkg: "", typ: $funcType([], [$Int], false)}]);
	Result.init([{prop: "Valid", name: "Valid", pkg: "", typ: $Bool, tag: ""}, {prop: "Title", name: "Title", pkg: "", typ: $String, tag: ""}, {prop: "Subtitle", name: "Subtitle", pkg: "", typ: $String, tag: ""}, {prop: "Icon", name: "Icon", pkg: "", typ: $String, tag: ""}, {prop: "URL", name: "URL", pkg: "", typ: $String, tag: ""}, {prop: "ID", name: "ID", pkg: "", typ: $String, tag: ""}]);
	angularResults.init([{prop: "Scope", name: "", pkg: "", typ: ptrType, tag: ""}, {prop: "results", name: "results", pkg: "github.com/AmandaCameron/go-search", typ: sliceType$1, tag: ""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = angularjs.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$packages["main"] = (function() {
	var $pkg = {}, $init, search, main;
	search = $packages["github.com/AmandaCameron/go-search"];
	main = function() {
		var $ptr, _key, _map, cmds;
		cmds = (_map = new $Map(), _map);
		new search.Commands(cmds).Add("hello", "Say Hello", "", (function $b(inp, result) {
			var $ptr, inp, result, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; inp = $f.inp; result = $f.result; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			$r = result.AddResult(new search.Result.ptr(false, "Hello " + inp, "", "", "", "")); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f.inp = inp; $f.result = result; $f.$s = $s; $f.$r = $r; return $f;
		}));
		new search.Commands(cmds).Add("goodbye", "Say goodbye", "", (function $b(inp, result) {
			var $ptr, inp, result, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; inp = $f.inp; result = $f.result; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			$r = result.AddResult(new search.Result.ptr(false, "Gooebye " + inp, "", "", "", "")); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f.inp = inp; $f.result = result; $f.$s = $s; $f.$r = $r; return $f;
		}));
		search.Run((function $b(inp, result) {
			var $ptr, _r, _r$1, inp, result, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; _r = $f._r; _r$1 = $f._r$1; inp = $f.inp; result = $f.result; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			_r = new search.Commands(cmds).Process(inp, result); /* */ $s = 3; case 3: if($c) { $c = false; _r = _r.$blk(); } if (_r && _r.$blk !== undefined) { break s; }
			/* */ if (_r) { $s = 1; continue; }
			/* */ $s = 2; continue;
			/* if (_r) { */ case 1:
				return;
			/* } */ case 2:
			_r$1 = result.Len(); /* */ $s = 6; case 6: if($c) { $c = false; _r$1 = _r$1.$blk(); } if (_r$1 && _r$1.$blk !== undefined) { break s; }
			/* */ if (_r$1 === 0) { $s = 4; continue; }
			/* */ $s = 5; continue;
			/* if (_r$1 === 0) { */ case 4:
				$r = result.AddResult(new search.Result.ptr(false, "Unknown command '" + inp + "'", "", "", "", "")); /* */ $s = 7; case 7: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			/* } */ case 5:
			/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f._r = _r; $f._r$1 = _r$1; $f.inp = inp; $f.result = result; $f.$s = $s; $f.$r = $r; return $f;
		}));
	};
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = search.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		main();
		/* */ } return; } if ($f === undefined) { $f = { $blk: $init }; } $f.$s = $s; $f.$r = $r; return $f;
	};
	$pkg.$init = $init;
